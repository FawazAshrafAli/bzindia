...
from .views import (
    ...
    SubCategoryViewset, CategoryViewset, ServiceSliderDetailViewSet
    )
...
companies_router.register(r'slider-details', ServiceSliderDetailViewSet, basename="company-slider-detail")
